...
public class PlayerController : NetworkBehaviour
{
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        // 충돌한 게임 오브젝트의 태그가 "ForwardingWall"인지 확인
    ...
    public void repositionPlayer()
    {
        ...
        {
            if (GameObject.Find("SpawnPositionRed"))
            {
                transform.position = GameObject.Find("SpawnPositionRed").transform.position;
            }
            else
            {
        ...
        {
            if (GameObject.Find("SpawnPositionBlue"))
            {
                transform.position = GameObject.Find("SpawnPositionBlue").transform.position;
            }
            else
            {
                transform.position = new Vector3(4, 0, 0);
